...
If you do not want to save the simulation results locally, you can first save the model to a temporary directory using the function `tempdir()` before running the simulation.
