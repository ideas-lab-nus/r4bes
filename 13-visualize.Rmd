...
```{r, eval=FALSE}
# display the 5 colors from the "Set2" color palette
display.brewer.pal(5, "Set2")
```

```{r brewer-set2, echo=FALSE, eval=TRUE, out.height = "30%", out.width = "50%", fig.align='center'}
knitr::include_graphics("figures/brewer_set2.png")
```
...
```{r, fig.height=10}
ggplot(weather_data, aes(x = hour, y = wday, fill = dry_bulb_temperature)) +
    geom_tile() +
