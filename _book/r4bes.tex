...
\NormalTok{df[}\StringTok{"y"}\NormalTok{]}
\DocumentationTok{\#\#       y}
\DocumentationTok{\#\# 1   red}
\DocumentationTok{\#\# 2 green}
\DocumentationTok{\#\# 3  blue}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bldg }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}
  \FunctionTok{here}\NormalTok{(}\StringTok{"data"}\NormalTok{, }\StringTok{"building.csv"}\NormalTok{),}
  \AttributeTok{col\_names =} \FunctionTok{c}\NormalTok{(}
    \StringTok{"datetime"}\NormalTok{,}
    \StringTok{"power"}
...
\CommentTok{\# transform the datetime character vector into a datetime object using lubridate}
\NormalTok{bldg}\SpecialCharTok{$}\NormalTok{datetime }\OtherTok{\textless{}{-}} \FunctionTok{dmy\_hm}\NormalTok{(bldg}\SpecialCharTok{$}\NormalTok{datetime)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:01}
\DocumentationTok{\#\# }
...
\begin{Highlighting}[]
\NormalTok{job }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(epw, }\AttributeTok{dir =} \FunctionTok{tempdir}\NormalTok{())}
\DocumentationTok{\#\# Replace the existing IDF located at /private/var/folders/6l/8dz74knn0yd02c\_bt8fl1pk80000gn/T/Rtmp8E9SE5/RefBldgMediumOfficeNew2004\_Chicago.idf.}
\DocumentationTok{\#\# EnergyPlus Starting}
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:02}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Could not find platform independent libraries \textless{}prefix\textgreater{}}
\DocumentationTok{\#\# Could not find platform dependent libraries \textless{}exec\_prefix\textgreater{}}
\DocumentationTok{\#\# Consider setting $PYTHONHOME to \textless{}prefix\textgreater{}[:\textless{}exec\_prefix\textgreater{}]}
...
\NormalTok{job }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(}\AttributeTok{weather =}\NormalTok{ epw, }\AttributeTok{dir =} \FunctionTok{tempdir}\NormalTok{())}
\DocumentationTok{\#\# EnergyPlus Starting}
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:02}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Could not find platform independent libraries \textless{}prefix\textgreater{}}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-135-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-136-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-137-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-138-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-139-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-144-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-145-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-147-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-148-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-149-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-150-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-151-1.pdf}
...
Before creating the graphics using ggplot, we need to first extract the weather data, which we can easily carry out using the \texttt{\$data()} method since we have earlier parsed the EPW file into RStudio as an \texttt{Epw} object.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{class}\NormalTok{(epw}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{())}
\DocumentationTok{\#\# [1] "data.table" "data.frame"}
\FunctionTok{head}\NormalTok{(epw}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{())}
\DocumentationTok{\#\#               datetime year month day hour minute}
\DocumentationTok{\#\# 1: 2017{-}01{-}01 01:00:00 1986     1   1    1      0}
\DocumentationTok{\#\# 2: 2017{-}01{-}01 02:00:00 1986     1   1    2      0}
\DocumentationTok{\#\# 3: 2017{-}01{-}01 03:00:00 1986     1   1    3      0}
\DocumentationTok{\#\# 4: 2017{-}01{-}01 04:00:00 1986     1   1    4      0}
\DocumentationTok{\#\# 5: 2017{-}01{-}01 05:00:00 1986     1   1    5      0}
\DocumentationTok{\#\# 6: 2017{-}01{-}01 06:00:00 1986     1   1    6      0}
\DocumentationTok{\#\#                                           data\_source dry\_bulb\_temperature}
\DocumentationTok{\#\# 1: ?9?9?9?9E0?9?9?9?9?9?9?9?9?9?9?9?9?9?9*\_*9*9*9*9*9                {-}12.2}
\DocumentationTok{\#\# 2: ?9?9?9?9E0?9?9?9?9?9?9?9?9?9?9?9?9?9?9*\_*9*9*9*9*9                {-}11.7}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{weather\_data }\OtherTok{\textless{}{-}}\NormalTok{ epw}\SpecialCharTok{$}\FunctionTok{data}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{select}\NormalTok{(datetime, dry\_bulb\_temperature) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{month =} \FunctionTok{month}\NormalTok{(datetime, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{),}
           \AttributeTok{day =} \FunctionTok{day}\NormalTok{(datetime),}
           \AttributeTok{wday =} \FunctionTok{wday}\NormalTok{(datetime, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{),}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-154-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-155-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-156-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-157-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{job }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(}\AttributeTok{weather =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{dir =} \FunctionTok{tempdir}\NormalTok{())}
\DocumentationTok{\#\# Replace the existing IDF located at /private/var/folders/6l/8dz74knn0yd02c\_bt8fl1pk80000gn/T/Rtmp8E9SE5/RefBldgMediumOfficeNew2004\_Chicago.idf.}
\DocumentationTok{\#\# EnergyPlus Starting}
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:03}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Could not find platform independent libraries \textless{}prefix\textgreater{}}
\DocumentationTok{\#\# Could not find platform dependent libraries \textless{}exec\_prefix\textgreater{}}
\DocumentationTok{\#\# Consider setting $PYTHONHOME to \textless{}prefix\textgreater{}[:\textless{}exec\_prefix\textgreater{}]}
...
You can then retrieve the list of available variables and meters with the function \texttt{read\_rdd()} and the \texttt{read\_mdd()} function respectively. Both functions return a five column \texttt{data.table}.
...
\DocumentationTok{\#\#   * Simulation started: 2021{-}10{-}13 23:03:00}
\DocumentationTok{\#\# }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rdd }\OtherTok{\textless{}{-}}\NormalTok{ job}\SpecialCharTok{$}\FunctionTok{read\_rdd}\NormalTok{()}
\NormalTok{rdd}
\DocumentationTok{\#\# == EnergyPlus Report Data Dictionary File ======================================}
\DocumentationTok{\#\#   * EnergyPlus version: 9.4.0 (998c4b761e)}
\DocumentationTok{\#\#   * Simulation started: 2021{-}10{-}13 23:03:00}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-}{-} Details {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\#      index reported\_time\_step report\_type}
\DocumentationTok{\#\#   1:     1               Zone     Average}
\DocumentationTok{\#\#   2:     2               Zone     Average}
\DocumentationTok{\#\#   3:     3               Zone     Average}
\DocumentationTok{\#\#   4:     4               Zone     Average}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model}\SpecialCharTok{$}\NormalTok{Output\_Variable }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\NormalTok{model}\SpecialCharTok{$}\NormalTok{Output\_Meter }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{output\_list }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{Output\_Variable =} \FunctionTok{list}\NormalTok{(}
        \AttributeTok{key\_value =} \StringTok{"*"}\NormalTok{,}
        \AttributeTok{Variable\_Name =} \StringTok{"Site Outdoor Air Drybulb Temperature"}\NormalTok{,}
        \AttributeTok{Reporting\_Frequency =} \StringTok{"Hourly"}\NormalTok{),}
    \AttributeTok{Output\_Variable =} \FunctionTok{list}\NormalTok{(}
        \AttributeTok{key\_value =} \StringTok{"*"}\NormalTok{,}
        \AttributeTok{Variable\_Name =} \StringTok{"Zone Mean Air Temperature"}\NormalTok{,}
        \AttributeTok{Reporting\_Frequency =} \StringTok{"Hourly"}\NormalTok{),}
    \AttributeTok{Output\_Meter =} \FunctionTok{list}\NormalTok{(}
        \AttributeTok{key\_name =} \StringTok{"Cooling:Electricity"}\NormalTok{,}
        \AttributeTok{Reporting\_Frequency =} \StringTok{"Hourly"}\NormalTok{),}
    \AttributeTok{Output\_Meter =} \FunctionTok{list}\NormalTok{(}
        \AttributeTok{key\_name =} \StringTok{"Heating:NaturalGas"}\NormalTok{,}
        \AttributeTok{Reporting\_Frequency =} \StringTok{"Hourly"}\NormalTok{)}
\NormalTok{)}

\NormalTok{model}\SpecialCharTok{$}\FunctionTok{add}\NormalTok{(output\_list)}
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:682]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\DocumentationTok{\#\# ├─ 1 : "*",                !{-} Key Value}
\DocumentationTok{\#\# │─ 2*: "Site Outdoor Air Drybulb Temperature",  !{-} Variable Name}
\DocumentationTok{\#\# └─ 3 : "Hourly";           !{-} Reporting Frequency}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:683]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}

The above code to add meters and variables can become unnecessarily long if you are adding multiple objects of the same class (in the above example, the \texttt{Output:Meter} and \texttt{Output:Variable} class. You can take advantage of \texttt{data.table}'s \texttt{:=} operator to assign the object name by reference.
...
\NormalTok{model}\SpecialCharTok{$}\FunctionTok{add}\NormalTok{(}\AttributeTok{Output\_Variable :=}\NormalTok{ variables)}
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:686]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\DocumentationTok{\#\# ├─ 1 : "*",                !{-} Key Value}
\DocumentationTok{\#\# │─ 2*: "Site Outdoor Air Drybulb Temperature",  !{-} Variable Name}
\DocumentationTok{\#\# └─ 3 : "Hourly";           !{-} Reporting Frequency}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:687]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}

Likewise, you can use the \texttt{\$add()} method to add your variable meter of interest.
...
\NormalTok{meters }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{key\_name =} \FunctionTok{c}\NormalTok{(}
        ...
        \StringTok{"Heating:NaturalGas"}
\NormalTok{    ),}
    \AttributeTok{Reporting\_Frequency =} \StringTok{"Hourly"}
\NormalTok{)}

\CommentTok{\# add meter outputs to get hourly time{-}series energy consumption}
\NormalTok{model}\SpecialCharTok{$}\FunctionTok{add}\NormalTok{(}\AttributeTok{Output\_Meter :=}\NormalTok{ meters)}
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Meter\textquotesingle{}\textgreater{} [ID:688]}
\DocumentationTok{\#\# Class: \textless{}Output:Meter\textgreater{}}
\DocumentationTok{\#\# ├─ 1*: "Cooling:Electricity",  !{-} Key Name}
\DocumentationTok{\#\# └─ 2 : "Hourly";           !{-} Reporting Frequency}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Meter\textquotesingle{}\textgreater{} [ID:689]}
\DocumentationTok{\#\# Class: \textless{}Output:Meter\textgreater{}}
\DocumentationTok{\#\# ├─ 1*: "Heating:NaturalGas",  !{-} Key Name}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}

Here is a useful function \texttt{preprocess\_idf()} that you can use to preprocess your EnergyPlus simulations so that it (1) uses the weather file for the simulation, (2) presents energy consumption outputs in kWh, and (3) remove all existing output meters and variables and add the list of meters and variables provided as arguments to the function.
...
\NormalTok{    idf}\SpecialCharTok{$}\NormalTok{SimulationControl}\SpecialCharTok{$}\NormalTok{Run\_Simulation\_for\_Weather\_File\_Run\_Periods }\OtherTok{\textless{}{-}} \StringTok{"Yes"}
    ...
    \CommentTok{\# make sure simulation is not run for sizing periods}
\NormalTok{    idf}\SpecialCharTok{$}\NormalTok{SimulationControl}\SpecialCharTok{$}\NormalTok{Run\_Simulation\_for\_Sizing\_Periods }\OtherTok{\textless{}{-}} \StringTok{"No"}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model}\SpecialCharTok{$}\NormalTok{Output\_Variable}
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:691]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\DocumentationTok{\#\# ├─ 1 : "*",                !{-} Key Value}
\DocumentationTok{\#\# │─ 2*: "Site Outdoor Air Drybulb Temperature",  !{-} Variable Name}
\DocumentationTok{\#\# └─ 3 : "Hourly";           !{-} Reporting Frequency}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Variable\textquotesingle{}\textgreater{} [ID:692]}
\DocumentationTok{\#\# Class: \textless{}Output:Variable\textgreater{}}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model}\SpecialCharTok{$}\NormalTok{Output\_Meter}
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Meter\textquotesingle{}\textgreater{} [ID:682]}
\DocumentationTok{\#\# Class: \textless{}Output:Meter\textgreater{}}
\DocumentationTok{\#\# ├─ 1*: "Cooling:Electricity",  !{-} Key Name}
\DocumentationTok{\#\# └─ 2 : "Hourly";           !{-} Reporting Frequency}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# $\textless{}NA\textgreater{}}
\DocumentationTok{\#\# \textless{}IdfObject: \textquotesingle{}Output:Meter\textquotesingle{}\textgreater{} [ID:683]}
\DocumentationTok{\#\# Class: \textless{}Output:Meter\textgreater{}}
\DocumentationTok{\#\# ├─ 1*: "Heating:NaturalGas",  !{-} Key Name}
\NormalTok{....}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model}\SpecialCharTok{$}\FunctionTok{save}\NormalTok{(}\FunctionTok{here}\NormalTok{(}\StringTok{"data"}\NormalTok{, }\StringTok{"idf"}\NormalTok{, }\StringTok{"model\_preprocessed.idf"}\NormalTok{), }\AttributeTok{overwrite =} \ConstantTok{TRUE}\NormalTok{)}
\DocumentationTok{\#\# Replace the existing IDF located at /Users/adrianchong/Documents/GitHub/r4bes/data/idf/model\_preprocessed.idf.}
\NormalTok{job }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(epw, }\AttributeTok{dir =} \FunctionTok{tempdir}\NormalTok{())}
\DocumentationTok{\#\# EnergyPlus Starting}
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:03}
\DocumentationTok{\#\# }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{report }\OtherTok{\textless{}{-}}\NormalTok{ job}\SpecialCharTok{$}\FunctionTok{report\_data}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{drop\_na}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{select}\NormalTok{(datetime, name, value) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{filter}\NormalTok{(name }\SpecialCharTok{\%in\%}\NormalTok{ variables}\SpecialCharTok{$}\NormalTok{Variable\_Name }\SpecialCharTok{|}\NormalTok{ name }\SpecialCharTok{\%in\%}\NormalTok{ meters}\SpecialCharTok{$}\NormalTok{key\_name) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pivot\_wider}\NormalTok{(}\AttributeTok{names\_from =}\NormalTok{ name, }\AttributeTok{values\_from =}\NormalTok{ value)}

\FunctionTok{head}\NormalTok{(report)}
\DocumentationTok{\#\# \# A tibble: 6 x 12}
\DocumentationTok{\#\#   datetime            \textasciigrave{}Site Outdoor Air D\textasciitilde{} \textasciigrave{}Site Outdoor Air \textasciitilde{} \textasciigrave{}InteriorLights:\textasciitilde{}}
\DocumentationTok{\#\#   \textless{}dttm\textgreater{}                             \textless{}dbl\textgreater{}               \textless{}dbl\textgreater{}             \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 2021{-}01{-}01 01:00:00                {-}7.82                72.6          9649498.}
\DocumentationTok{\#\# 2 2021{-}01{-}01 02:00:00               {-}11.9                 73            9649498.}
\DocumentationTok{\#\# 3 2021{-}01{-}01 03:00:00               {-}11.4                 73            9649498.}
\DocumentationTok{\#\# 4 2021{-}01{-}01 04:00:00               {-}11.1                 73            9649498.}
\DocumentationTok{\#\# 5 2021{-}01{-}01 05:00:00               {-}10.8                 73            9649498.}
\DocumentationTok{\#\# 6 2021{-}01{-}01 06:00:00               {-}10.6                 73            9649498.}
\DocumentationTok{\#\# \# ... with 8 more variables: InteriorEquipment:Electricity \textless{}dbl\textgreater{},}
\NormalTok{....}
\end{Highlighting}
\end{Shaded}

\hypertarget{mtd-file}{%
\section{mtd file}\label{mtd-file}}
...
Before carrying out any model exploration, you need to first specify the outputs of interest. The code below preprocesses the model by adding the list of output meters and variables to the model (See Chapter \ref{output} for details).
...
\DocumentationTok{\#\# Replace the existing IDF located at /Users/adrianchong/Documents/GitHub/r4bes/data/idf/model\_preprocessed.idf.}
\NormalTok{job }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\FunctionTok{run}\NormalTok{(epw, }\AttributeTok{dir =} \FunctionTok{tempdir}\NormalTok{())}
\DocumentationTok{\#\# Replace the existing IDF located at /private/var/folders/6l/8dz74knn0yd02c\_bt8fl1pk80000gn/T/Rtmp8E9SE5/model\_preprocessed.idf.}
\DocumentationTok{\#\# EnergyPlus Starting}
\DocumentationTok{\#\# EnergyPlus, Version 9.4.0{-}998c4b761e, YMD=2021.10.13 23:03}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Could not find platform independent libraries \textless{}prefix\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pt\_of\_interest }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Site Outdoor Air Drybulb Temperature"}\NormalTok{,}
                    \StringTok{"Cooling:Electricity"}\NormalTok{,}
                    \StringTok{"Heating:NaturalGas"}\NormalTok{)}
...
\NormalTok{report }\OtherTok{\textless{}{-}}\NormalTok{ job}\SpecialCharTok{$}\FunctionTok{report\_data}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{drop\_na}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(datetime, name, value) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(name }\SpecialCharTok{\%in\%}\NormalTok{ pt\_of\_interest) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{pivot\_longer}\NormalTok{(}\AttributeTok{cols =} \FunctionTok{c}\NormalTok{(}\StringTok{"Cooling:Electricity"}\NormalTok{, }\StringTok{"Heating:NaturalGas"}\NormalTok{), }
               \AttributeTok{names\_to =} \StringTok{"type"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"value"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{value =}\NormalTok{ value }\SpecialCharTok{*} \FloatTok{1e{-}6}\NormalTok{, }\CommentTok{\# convert J to MJ}
         \AttributeTok{month =} \FunctionTok{month}\NormalTok{(datetime, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{), }\CommentTok{\# create a new column containing the month}
         \AttributeTok{day =} \FunctionTok{day}\NormalTok{(datetime), }\CommentTok{\# create a new column containing the day of the month}
         \AttributeTok{wday =} \FunctionTok{wday}\NormalTok{(datetime, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{), }\CommentTok{\# create a new column containing day of the week}
         \AttributeTok{hour =} \FunctionTok{hour}\NormalTok{(datetime)) }\CommentTok{\# create a new column containing the hour of the day}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-210-1.pdf}
...
\includegraphics{r4bes_files/figure-latex/unnamed-chunk-211-1.pdf}
